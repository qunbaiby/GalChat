...
func _ready() -> void:
	...
	var guide_btn: Button = %GuideButton
	...
	_panel_base_position = panel_container.position
	hide()
...
func show_panel() -> void:
	...
	show()
	modulate.a = 1.0
	panel_container.position = _panel_base_position + Vector2(PANEL_ENTER_OFFSET_X, 0.0)
	panel_container.modulate.a = 0.0
	_panel_tween = create_tween().set_parallel(true)
	_panel_tween.tween_property(panel_container, "position", _panel_base_position, PANEL_ENTER_DURATION).set_ease(Tween.EASE_OUT).set_trans(Tween.TRANS_QUART)
	_panel_tween.tween_property(panel_container, "modulate:a", 1.0, PANEL_ENTER_DURATION).set_ease(Tween.EASE_OUT).set_trans(Tween.TRANS_QUART)
...
func hide_panel() -> void:
	...
	_stop_panel_tween()
	_panel_tween = create_tween().set_parallel(true)
	_panel_tween.tween_property(panel_container, "position", _panel_base_position, PANEL_EXIT_DURATION).set_ease(Tween.EASE_IN).set_trans(Tween.TRANS_QUART)
	_panel_tween.tween_property(panel_container, "modulate:a", 0.0, PANEL_EXIT_DURATION).set_ease(Tween.EASE_IN).set_trans(Tween.TRANS_QUART)
...
func _finish_hide_panel() -> void:
	panel_container.position = _panel_base_position
