...
@onready var title_label: Label = $HBox/VBox/TitleLabel
@onready var artist_label: Label = $HBox/VBox/ArtistLabel
@onready var play_icon: Label = $HBox/PlayIcon
@onready var star_btn: Button = $HBox/StarBtn
@onready var checkbox: CheckBox = $HBox/CheckBox
...
func _ready() -> void:
	...
	star_btn.pressed.connect(_on_star_pressed)
