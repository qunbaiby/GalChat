...
@onready var energy_value = $MarginContainer/HBoxContainer/EnergyBox/VBoxContainer/ValueLabel
@onready var energy_progress = $MarginContainer/HBoxContainer/EnergyBox/VBoxContainer/ProgressBar
@onready var stress_value = $MarginContainer/HBoxContainer/StressBox/VBoxContainer/ValueLabel
@onready var stress_progress = $MarginContainer/HBoxContainer/StressBox/VBoxContainer/ProgressBar
