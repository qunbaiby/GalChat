...
@onready var galchat_button: Button = $UIPanel/GalChatButton
...
@onready var affection_button: Button = $UIPanel/SystemButton/AffectionButton
@onready var archive_button: Button = $UIPanel/BottomButton/ArchiveButton
...
func _on_archive_pressed() -> void:
	...
	if archive_panel_instance == null:
		...
		ui_panel.add_child(archive_panel_instance)
...
func _on_affection_pressed() -> void:
	...
	if affection_panel_instance == null:
		...
		affection_panel_instance.set_anchors_and_offsets_preset(Control.PRESET_TOP_RIGHT)
		affection_panel_instance.offset_left = -320
		affection_panel_instance.offset_top = 18
		affection_panel_instance.offset_right = 0
		affection_panel_instance.offset_bottom = 252
		
	affection_panel_instance.visible = not affection_panel_instance.visible
