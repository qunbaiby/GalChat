...
const PANEL_MIN_SIZE := Vector2(1120, 700)

@onready var background_panel: Panel = $Background
@onready var panel_root: PanelContainer = $CenterContainer/PanelRoot
@onready var back_btn: Button = $CenterContainer/PanelRoot/RootCanvas/HeaderPanel/Margin/TopBar/BackBtn
@onready var title_label: Label = $CenterContainer/PanelRoot/RootCanvas/HeaderPanel/Margin/TopBar/Title
...
@onready var name_label: Label = $CenterContainer/PanelRoot/RootCanvas/BodyCanvas/InfoColumn/ContainerMargin/InfoContainer/NameLabel
@onready var intro_label: Label = $CenterContainer/PanelRoot/RootCanvas/BodyCanvas/InfoColumn/ContainerMargin/InfoContainer/IntroLabel
@onready var age_value_label: Label = $CenterContainer/PanelRoot/RootCanvas/BodyCanvas/InfoColumn/ContainerMargin/InfoContainer/MetaVBox/AgeRow/HBox/Value
@onready var birthday_value_label: Label = $CenterContainer/PanelRoot/RootCanvas/BodyCanvas/InfoColumn/ContainerMargin/InfoContainer/MetaVBox/BirthdayRow/HBox/Value
@onready var zodiac_value_label: Label = $CenterContainer/PanelRoot/RootCanvas/BodyCanvas/InfoColumn/ContainerMargin/InfoContainer/MetaVBox/ZodiacRow/HBox/Value
@onready var description_label: Label = $CenterContainer/PanelRoot/RootCanvas/BodyCanvas/InfoColumn/ContainerMargin/InfoContainer/DescriptionBody
...
func _update_popup_layout() -> void:
	panel_root.custom_minimum_size = PANEL_MIN_SIZE
