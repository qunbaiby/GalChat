...
@onready var back_button: Button = $CenterContainer/PanelRoot/MainMargin/RootVBox/TopBar/BackButton
@onready var header_title_label: Label = $CenterContainer/PanelRoot/MainMargin/RootVBox/TopBar/Title
@onready var header_hint_label: Label = $CenterContainer/PanelRoot/MainMargin/RootVBox/TopBar/HeaderHint
