...
func _request_ai_dialogue():
	...
	var event_desc = "玩家点了一份【" + item_name + "】，你刚刚制作完成并端给玩家，请对玩家说一句符合当前场景和服务员身份的台词（字数控制在20字以内）。"
...
func _on_consume_button_pressed():
	...
	tween.tween_callback(func():
		...
		if target_scene and target_scene.has_method("_show_action_bubble_from_ai"):
			target_scene._show_action_bubble_from_ai("order", ai_response_text)
