...
@onready var tool_mode_chip: Label = get_node_or_null("Control/QuickToolsPanel/Canvas/ShellMargin/MainHBox/LeftColumn/HeaderMargin/HeaderCard/HeaderVBox/NameRow/ModeChip") as Label
