...
@onready var tool_title_label: Label = $Control/QuickToolsPanel/MarginContainer/VBoxContainer/Screen/ScreenMargin/ScreenStack/DashboardRoot/TimeWidget/MarginContainer/HeaderRow/InfoVBox/Title
@onready var tool_subtitle_label: Label = $Control/QuickToolsPanel/MarginContainer/VBoxContainer/Screen/ScreenMargin/ScreenStack/DashboardRoot/TimeWidget/MarginContainer/HeaderRow/InfoVBox/SubTitle
@onready var tool_clock_label: Label = $Control/QuickToolsPanel/MarginContainer/VBoxContainer/Screen/ScreenMargin/ScreenStack/DashboardRoot/TimeWidget/MarginContainer/HeaderRow/ClockLabel
...
@onready var main_window_button: Button = $Control/QuickToolsPanel/MarginContainer/VBoxContainer/Screen/ScreenMargin/ScreenStack/DashboardRoot/PrimaryButtons/MainWindowButton
...
@onready var pet_settings_button: Button = get_node_or_null("Control/QuickToolsPanel/MarginContainer/VBoxContainer/Screen/ScreenMargin/ScreenStack/DashboardRoot/PrimaryButtons/PetSettingsButton") as Button
@onready var close_button: Button = $Control/QuickToolsPanel/MarginContainer/VBoxContainer/Screen/ScreenMargin/ScreenStack/DashboardRoot/ToolButtons/CloseButton
@onready var pomodoro_toggle_button: Button = $Control/QuickToolsPanel/MarginContainer/VBoxContainer/Screen/ScreenMargin/ScreenStack/DashboardRoot/ToolButtons/PomodoroToggleButton
@onready var music_toggle_button: Button = $Control/QuickToolsPanel/MarginContainer/VBoxContainer/Screen/ScreenMargin/ScreenStack/DashboardRoot/ToolButtons/MusicToggleButton
...
func _get_pomodoro_panel_instance() -> Control:
    ...
    var panel_scene := load("res://scenes/ui/main/pomodoro_panel.tscn")
    if panel_scene == null:
        return null
