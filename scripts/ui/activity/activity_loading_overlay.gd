...
func _play_visual_animation() -> void:
	...
	_icon_tween.tween_property(icon_pivot, "position:y", -10.0, 1.0).set_trans(Tween.TRANS_SINE).set_ease(Tween.EASE_OUT)
	_icon_tween.tween_property(icon_pivot, "position:y", 8.0, 1.0).set_trans(Tween.TRANS_SINE).set_ease(Tween.EASE_IN_OUT)
	_icon_tween.tween_property(icon_pivot, "position:y", 0.0, 0.85).set_trans(Tween.TRANS_SINE).set_ease(Tween.EASE_IN)
