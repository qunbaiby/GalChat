...
@onready var icon_rect: TextureRect = $Control/CenterContainer/PopupPanel/HBox/LeftAreaMargin/LeftArea/VBox/IconMargin/Icon
@onready var owned_label: Label = $Control/CenterContainer/PopupPanel/HBox/LeftAreaMargin/LeftArea/VBox/OwnedBox/HBox/OwnedLabel
@onready var title_label: Label = $Control/CenterContainer/PopupPanel/HBox/RightArea/VBox/TitleBar/Margin/TitleLabel
@onready var item_name_label: Label = $Control/CenterContainer/PopupPanel/HBox/RightArea/VBox/TopHBox/ItemNameLabel
