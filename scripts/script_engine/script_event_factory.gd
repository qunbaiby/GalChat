...
static func create_event(data: Dictionary): # 返回 ScriptEvent
    ...
    match type:
        ...
        "period_card":
            return preload("res://scripts/script_engine/events/event_period_card.gd").new(data)
        "show_character":
            return preload("res://scripts/script_engine/events/event_show_character.gd").new(data)
        "move_character":
            return preload("res://scripts/script_engine/events/event_move_character.gd").new(data)
        "hide_character":
